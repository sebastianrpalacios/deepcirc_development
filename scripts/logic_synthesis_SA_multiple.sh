...
#SBATCH --job-name=SA_11400

IDS=("0x0239" "0x040B" "0x0575" "0x0643" "0x0760" "0x09AF" "0x0F42" "0x1048"
     "0x10C9" "0x1284" "0x1858" "0x1AC6" "0x22C6" "0x23A7" "0x240F"
...
for ID in "${IDS[@]}"; do
  OUTPUT_FOLDER="/home/gridsan/spalacios/Designing complex biological circuits with deep neural networks/manuscript/logic_synthesis_SA/11400_steps/4_inputs/no_fw_preference/${ID}/seed_1"
