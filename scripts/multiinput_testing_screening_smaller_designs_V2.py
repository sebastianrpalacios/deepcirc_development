...
n_values_set = {n for n in n_values if n > 1000}
# %%
results = {}
...
for value_decimal, G in graphs_library_4_input_ABC.items():
    ...
    #if value_decimal not in range(1000, 2000):
    #    continue
    
    if value_decimal not in n_values_set:
        continue
...
pickle_path = out_dir / "screening_for_keys_where_ABC_is_outperformed_initial_num_gates_all_keys_largerthan1000_1perpermutationclass.pkl"
...
csv_path = out_dir / "screening_for_keys_where_ABC_is_outperformed_initial_num_gates6_all_keys_largerthan1000_1perpermutationclass.csv"
