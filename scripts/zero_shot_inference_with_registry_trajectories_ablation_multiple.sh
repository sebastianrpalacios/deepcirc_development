...
for ID in "${IDS[@]}"; do
  OUTPUT_FOLDER="/home/gridsan/spalacios/Designing complex biological circuits with deep neural networks/manuscript/zero-shot/ablation/GAT_with_scalars_/initial_state_sampling_factor_0/4_inputs_${ID}_samplingfactor_3_4000nn/seed_1"
  ...
  (
    ...
    python zero_shot_inference_with_registry_trajectories_ablation.py \
