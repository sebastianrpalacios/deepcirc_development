...
out_csv = Path("/home/gridsan/spalacios/Designing complex biological circuits with deep neural networks/manuscript/shared_registry_analysis") / "Fig. 2 sizes fine-tuning 4 input circuits plus hex verification and validation seed 1 (automated analysis).csv"
