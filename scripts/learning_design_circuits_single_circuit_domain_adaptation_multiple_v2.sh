...
for ID in "${IDS[@]}"; do
    OUTPUT_FOLDER="/home/gridsan/spalacios/Designing complex biological circuits with deep neural networks/manuscript_v2/fine_tune/GAT_MLP_with_scalars/4000nn/initial_state_sampling_factor_4/4_inputs/50_000_steps/${ID}/seed_1"
    ...
    python design_circuits_v2.py \
        ...
        --target_hex "${ID}" \
        --fine_tuning "/home/gridsan/spalacios/Designing complex biological circuits with deep neural networks/manuscript_v2/trained_agents/GAT_MLP_with_scalars_4000_logic_functions/trained_model.zip"
    )
done  
