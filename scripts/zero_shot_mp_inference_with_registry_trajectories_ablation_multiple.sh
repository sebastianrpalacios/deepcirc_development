...
for ID in "${IDS[@]}"; do
  OUTPUT_FOLDER="/home/gridsan/spalacios/Designing complex biological circuits with deep neural networks/manuscript/zero-shot/mp/50_000_steps/4_inputs/initial_state_sampling_factor_0/${ID}/seed_1"
  ...
  (
    ...
    python zero_shot_mp_inference_with_registry_trajectories_ablation.py \
