...
#SBATCH --job-name=0x699D_finetune

OUTPUT_FOLDER="/home/gridsan/spalacios/Designing complex biological circuits with deep neural networks/manuscript/fine_tune/GAT_MLP_with_scalars_/initial_state_sampling_factor_0/4_inputs_0x699D_samplingfactor_0_4000nn/seed_1"
